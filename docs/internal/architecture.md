...
| ------------------- | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| Grammar + parser    | `src/parser`               | Mode-specific text-to-AST parsing. SelectionDAG uses an Ohm-js grammar with lazy compilation via `grammarCache.ts`. Mermaid adapts the pinned upstream flowchart parser into `MermaidAST`.        | no          |
