// Temporary step-8 copy of src/parser/__tests__/llvm/invariants.test.ts
// retargeted at the line-oriented parser; deleted in step 9 when the
// original suites point at the new parser via llvm/index.
import { describe, expect, it } from "vitest";
import { parseLLVMToAST } from "../../parse";
import { llvmComplexModule } from "../../../__tests__/helpers/llvmFixtures";
