...
semantics.addOperation('parse', {
    ...
    NodeDeclaration(id: any, label: any, _sep: any) {
        ...
        return { type: 'node_decl', node: { id: nodeId, label: nodeLabel?.text, type: nodeLabel?.shape } };
    },
    ...
    Link_arrowWithLabel(_arrow: any, _pipe1: any, text: any, _pipe2: any) {
        return { type: 'arrow', label: text.numChildren > 0 ? text.sourceString : undefined };
    },
    Link_lineWithLabel(_line: any, _pipe1: any, text: any, _pipe2: any) {
        return { type: 'line', label: text.numChildren > 0 ? text.sourceString : undefined };
    },
